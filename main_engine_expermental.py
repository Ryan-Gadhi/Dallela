...
print( eng.compute("hour lost for baker in april 2019") )

# print( eng.compute("show the activity on the well dmmm129") )
...
# print( eng.compute("Show me the fields with the most producing wells") )
